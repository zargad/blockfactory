...
execute if entity @e[tag=ochre,tag=!no,sort=nearest,limit=1,distance=..9.5] at @a[tag=nice] run particle minecraft:dust_color_transition 1 1 0 1 1 1 1 ~ ~-.5 ~ .5 .5 .5 0 50 normal
