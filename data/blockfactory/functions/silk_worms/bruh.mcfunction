execute align xyz unless entity @e[type=item_display,tag=init,distance=..0.5] run summon minecraft:item_display ~.5 ~.5 ~.5 {item:{id:"minecraft:rabbit_foot",Count:1s}}
