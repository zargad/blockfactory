...
execute if entity @e[tag=verdant,tag=!no,sort=nearest,limit=1,distance=..9.5] at @a[tag=nice] run particle minecraft:dust_color_transition{from_color: [0, 1, 0], scale: 1, to_color: [1, 1, 1]} ~ ~-.5 ~ .5 .5 .5 0 50 normal
