...
execute unless block ~ ~-1 ~ hopper if block ~ ~1 ~ air run summon item ~ ~1 ~ {Item:{id:"minecraft:dirt",Count:1b}}
execute unless block ~ ~-1 ~ hopper unless block ~ ~1 ~ air run summon item ~ ~ ~ {Item:{id:"minecraft:dirt",Count:1b}}
